...
if __name__ == "__main__":
    ...
    parser.add_argument('--face_path', type=Path, default='img/001.jpg', help='Path to the face image')
    parser.add_argument('--shape_path', type=Path, default='img/002.jpg', help='Path to the shape image')
    parser.add_argument('--color_path', type=Path, default='img/003.jpg', help='Path to the color image')
    parser.add_argument('--result_path', type=Path, default='img/004.jpg', help='Path to save the result')
